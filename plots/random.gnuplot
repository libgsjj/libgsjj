...
plot "random.data" using 20:xtic(1) title "Méthode binaire de Grinchtein, Leucker et Piterman - moyenne" linecolor rgb "#AAFFAA",\
    "" using 21:xtic(1) title "Méthode binaire de Grinchtein, Leucker et Piterman - médianne" linecolor rgb "#AAFFAA" fillstyle pattern 5,\
    "" using ($1)-0.84:22 title "Méthode binaire de Grinchtein, Leucker et Piterman - nombre de timeouts" axes x1y2 with points pointsize 2 pointtype 7 linecolor rgb "#AAFFAA"
...
plot "random.data" using 17:xtic(1) title "Méthode unaire de Grinchtein, Leucker et Piterman - moyenne" linecolor rgb "#5555FF",\
    ...
    "" using 20:xtic(1) title "Méthode binaire de Grinchtein, Leucker et Piterman - moyenne" linecolor rgb "#AAFFAA",\
    "" using 21:xtic(1) title "Méthode binaire de Grinchtein, Leucker et Piterman - médianne" linecolor rgb "#AAFFAA" fillstyle pattern 5,\
    "" using ($1)-0.92:22 title "Méthode binaire de Grinchtein, Leucker et Piterman - nombre de timeouts" axes x1y2 with points pointsize 2 pointtype 7 linecolor rgb "#AAFFAA",\
...
# A plot with all SAT methods
set output "random_sat.png"
set title "Temps d'exécution moyen et médian et pourcentage d'échecs en fonction du nombre de mots dans (S_+, S_-) pour les méthodes SAT"
plot "random.data" using 8:xtic(1) title "Méthode unaire de Grinchtein, Leucker et Piterman (CNF) - moyenne" linecolor rgb "#0000FF",\
    "" using 9:xtic(1) title "Méthode unaire de Grinchtein, Leucker et Piterman (CNF) - médianne" linecolor rgb "#0000FF" fillstyle pattern 5,\
    "" using 17:xtic(1) title "Méthode unaire de Grinchtein, Leucker et Piterman (non CNF) - moyenne" linecolor rgb "#5555FF",\
    ...
    "" using 11:xtic(1) title "Méthode binaire de Grinchtein, Leucker et Piterman (CNF) - moyenne" linecolor rgb "#00FF00",\
    "" using 12:xtic(1) title "Méthode binaire de Grinchtein, Leucker et Piterman (CNF) - médianne" linecolor rgb "#00FF00" fillstyle pattern 5,\
    "" using 20:xtic(1) title "Méthode binaire de Grinchtein, Leucker et Piterman (non CNF) - moyenne" linecolor rgb "#AAFFAA",\
    "" using 21:xtic(1) title "Méthode binaire de Grinchtein, Leucker et Piterman (non CNF) - médianne" linecolor rgb "#AAFFAA" fillstyle pattern 5,\
    "" using 14:xtic(1) title "Méthode de Heule et Verwer (CNF) - moyenne" linecolor rgb "#FF00FF",\
    "" using 15:xtic(1) title "Méthode de Heule et Verwer (CNF) - médianne" linecolor rgb "#FF00FF" fillstyle pattern 5,\

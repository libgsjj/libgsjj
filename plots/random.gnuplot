...
plot "random.data" using 8:xtic(1) title "Méthode unaire de Grinchtein, Leucker et Piterman (CNF) - moyenne" linecolor rgb "#0000FF",\
    ...
    "" using ($1)-1.21:10 title "Méthode unaire de Grinchtein, Leucker et Piterman (CNF) - nombre de timeouts" axes x1y2 with points pointsize 2 pointtype 9 linecolor rgb "#0000FF",\
    ...
    "" using ($1)-0.92:13 title "Méthode binaire de Grinchtein, Leucker et Piterman (CNF) - nombre de timeouts" axes x1y2 with points pointsize 2 pointtype 5 linecolor rgb "#00FF00",\
    ...
    "" using ($1)-0.637:16 title "Méthode de Heule et Verwer (CNF) - nombre de timeouts" axes x1y2 with points pointsize 2 pointtype 7 linecolor rgb "#FF00FF",\

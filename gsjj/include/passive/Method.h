...
namespace passive {
    ...
    public:
         ...
         * @param Sp The \f$S_+\f$ set
         * @param Sm The \f$S_-\f$ set
         * @param S The \f$S = S_+ \cup S_-\f$ set. See computeS
         * @param prefixes The \f$Pref(S)\f$ set. See computePrefixes
    ...
    public:
         ...
         * @param timeout The maximum number of time the method can use, in milliseconds. If <= 0, there is no limit.
         */

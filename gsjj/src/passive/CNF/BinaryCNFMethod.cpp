...
namespace passive {
    namespace CNF {
        ...
        void BinaryCNFMethod::createFormula() {
            /**
             *  Notes on how to use the SAT solvers:
             *  - Create every needed variable and store them
             *  - Create formula using these variables
             *  - force_true the resulting formula
             *  - Call minisat_solve TODO: find correct arguments
             *  - The variables have a field "value" that stores whether the variable is true or false
             */
